...
| Outlook draft / Google Workspace         | Organization scoped       | Communication draft target         | `drafts.create` implemented, disabled | Production mailbox/delegation, credential provisioning, allowlists, audit retention, and crash-window policy |
